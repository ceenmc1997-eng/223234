...
const Contact = () => {
  ...
  return (
    <div data-testid="contact-page" className="min-h-screen pt-24">
      ...
      {/* Brochure Download Section - Compact */}
      <section className="py-10 md:py-12">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="bg-zinc-900/50 border border-zinc-800/50 rounded-xl p-6 flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm">
                  Download our brochure with company info, TPM details & registration forms
                </p>
              </div>
            </div>
            <a 
            ...
            >
              <Button
                className="bg-[#22C55E] text-black hover:bg-[#22C55E]/90 rounded-full px-6 whitespace-nowrap"
              >
